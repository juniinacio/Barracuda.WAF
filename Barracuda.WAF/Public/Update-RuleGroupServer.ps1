...
#>
function Update-RuleGroupServer {
    [CmdletBinding()]
    [Alias()]
    ...
    process {
        try {
            ...
            $PSBoundParameters |
                ConvertTo-PostData |
                    Invoke-API -Path ('/restapi/v3/services/{0}/content-rules/{1}/content-rule-servers/{2}' -f $WebApplicationName, $RuleGroupName, $WebServerName) -Method Put
        } catch {
