...
function Update-UrlAcl {
    ...
    process {
        try {
            ...
            $PSBoundParameters.Remove('URLACLName') | Out-Null

            $PSBoundParameters.name = $URLACLName
            ...
            $PSBoundParameters |
                ConvertTo-PostData |
                    Invoke-API -Path ('/restapi/v3/services/{0}/url-acls/{1}' -f $WebApplicationName, $URLACLName) -Method Put
        } catch {
