...
InModuleScope Barracuda.WAF {
    Describe "Get-BarracudaWAFSystemLocationInformation" {

        It "should retrieve information of location" {
            Mock Invoke-Api {}

            Get-BarracudaWAFSystemLocationInformation
        ...
        It "should retrieve a specific location information parameter" {
            ...
            Get-BarracudaWAFSystemLocationInformation -Parameters 'country'
