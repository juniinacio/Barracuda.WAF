...
InModuleScope Barracuda.WAF {
    Describe "Update-BarracudaWAFBasicSecurity" {
...
"@          | ConvertFrom-Json
            ...
            $inputObject | Update-BarracudaWAFBasicSecurity -WebApplicationName 'default'

            Assert-MockCalled Invoke-Api -ParameterFilter {
                        $Path -eq "/restapi/v3/services/default/basic-security" `
                -and    $Method -eq 'Put' `
